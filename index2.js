...
//     if(item.objectRelation) {
//         let object = objects.find(x => x.id === item.objectRelation.objectId)
//         if(object.enabled) {
//             return [
//                 ...acc, {
//                     ...item, permissions: {view: true, edit: true, remove: true}
//                 }
//             ]
//         }
//         return [
//             ...acc, {
//                 ...item, permissions: {view: false, edit: false, remove: false}
//             }
//         ]
//     }
//     return acc;
...
//     if (item.objectRelation) {
//         for (let value of objects) {
//             if (item.objectRelation.objectId === value.id) {
//                 return [...acc, value]
//             }
//         }
//     }
